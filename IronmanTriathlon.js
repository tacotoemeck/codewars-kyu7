...
function iTri(s){
let distanceLeft = (140.6 - s).toFixed(2);
if (s == 0) return 'Starting Line... Good Luck!';
if ( s < 2.4 ) return {'Swim': distanceLeft + ' to go!'};
if ( s > 2.4 && s < 114.4 ) return {'Bike': distanceLeft + ' to go!'};
if ( s > 114.3 && s < 130.6 ) return {'Run': distanceLeft + ' to go!'};
if ( s > 130.6 && s < 140.6) return {'Run': 'Nearly there!'};
